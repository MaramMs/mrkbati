  ...
  return (
    <>
          ...
          <Row>
            ...
            <Col xs={12} md={6}>
              ...
              <p className="text-[#1D1E25] font-normal md:text-[19px] text-[12px] ">
                منصة مركبتي تقدم حلولاً مبتكرة وفعالة تعالج مشاكل النقل
                والمواصلات عبر تقديم خدمات إلكترونية سهلة الوصول
              </p>
      ...
      <section className=" md:px-[121px] mt-[50px]">
        <div className="flex flex-col items-center justify-center gap-[10px]">
          <h2 className="text-[30px] md:!text-[50px] !font-bold !text-[#1F1F39]">
            مزايا استخدام منصة{" "}
            <span className="text-[#32A8C9] !text-[50px] !font-bold">
              {" "}
              مركبتي
            </span>
          </h2>
        ...
        <Container className="py-[30px] bg-[#F7FDFF] mt-[50px] ">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[50px]">
            <div className="md:text-left">
              ...
              <h3 className="!mb-[10px] !text-[#1F1F39] !text-[20px] !font-bold">
                سهولة الاستخدام
              </h3>
            ...
            <div className="hidden  text-center row-span-2 md:flex items-center justify-center ">
              <div className="relative w-[430px] h-[430px] bg-[rgba(208,245,255,0.49)] rounded-[50%] z-[1]">
                <img
                  ...
                  alt="Phone"
                  className=" z-2 absolute lg:top-[5%] xl:top-[-19%]"
                />
              </div>
            </div>
        ...
        <div className="text-center  flex flex-col !gap-[15px] mt-[30px] border-b-[1px] border-b-[rgba(31,31,57,0.1)] pb-2">
          <h2 className="text-[#1F1F39] !font-bold !text-[16px]">
            استمتع بمزايا مركبتي
          </h2>
      ...
      <section className="md:px-[121px] mt-[50px] ">
        <div className="flex flex-col items-center justify-center gap-[10px]">
          ...
          <p className="text-[#1F1F3980] opacity-[50%] text-[14px] md:text-[20px] font-normal text-center md:w-[50%] mx-auto !mb-[25px]">
            منصة مركبتي مصممة لخدمة جميع فئات المجتمع من السائقين المحترفين الى
            طلاب الجامعات لتسهيل الوصول الى خدمات النقل بكفاءة وراحة
          </p>
        </div>
        ...
        <div className="flex justify-center items-center gap-[7px]">
          ...
          <p className="text-[#1F1F39] text-[12px] !font-bold m-0">
            شاهد الفيديو
          </p>
        </div>
      ...
      <section className=" md:py-[115px] md:px-[121px] mt-[50px] bg-[#F7FDFF]">
        <h2 className="!text-[#1D1E25] text-[30px] md:!text-[60px] !font-bold text-center md:!mb-[60px]">
          الاسئلة الشائعة
        </h2>
