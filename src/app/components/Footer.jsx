...
const Footer = () => {
  return (
    <footer
      className="rounded-tl-[40px] rounded-tr-[40px]"
      style={{
        background:
          "radial-gradient(73.85% 131.13% at 42.85% 164.12%, #71D3FF 0%, #32A8C9 100%)",
      }}
    >
      <Container>
        <div>
          <div className="text-center text-white py-5 flex flex-col gap-[30px]">
            ...
            <p className="text-[24px] font-normal">
              لمزيد من المعلومات أو للتواصل معنا، يمكنكم استخدام أحد وسائل
              التواصل التالية{" "}
            </p>
          </div>
          ...
          <Row>
            <Col>
              <div className="flex flex-col gap-[41px]">
                ...
                <div className="flex items-center  gap-[10px]">
                  <IoIosPhonePortrait className="text-[24px] text-[#fff]" />
          ...
          <Row>
            <Col>
              <ul className="flex flex-col gap-[12px]">
                <li className="text-[#fff] text-[16px] font-bold">الرئيسي</li>
        ...
        <div className="flex sm:flex-col md:flex-row  justify-between items-center">
          <p className="text-[16px] font-normal text-[#fff]">
            مركبتي @ 2025. جميع الحقوق محفوظة.{" "}
          </p>

          <div className="flex sm:flex-col  md:flex-row justify-between items-center gap-[32px]">
            <Link
              href="/"
              className="!text-[#fff] !font-normal !text-[16px] !no-underline"
            >
              تواصل معنا
            </Link>
            <Link
