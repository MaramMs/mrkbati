        ...
        {["1", "2", "3", "4"].map((item, index) => (
          ...
          >
            ...
            <Accordion.Body className="text-[18px] md:text-base text-[#1D1E25] md:w-[80%]">
              من خلال تقديم طلب في تطبيق مركبتي والذهاب إلى شاشة إنشاء الحساب
              وإدخال المعلومات الخاصة بك والتي يطلبها التطبيق، ومن ثم الانتقال
              إلى شاشة المعلومات الشخصية واستكمال باقي المعلومات حتى يتم إرسال
              الطلب إلى الجهات المعنية، وبعد الموافقة على طلبك يمكنك التمتع
              بالخدمات التي يوفرها نظام مركبتي.
            </Accordion.Body>
          </Accordion.Item>
        ))}
      </Accordion>
